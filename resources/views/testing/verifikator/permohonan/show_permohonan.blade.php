        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h4 class="mb-0">Detail Permohonan Admin</h4>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <form action="{{ route('verifikator.permohonan.status', $permohonan->id_permohonan) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <button type="submit" class="btn {{ $permohonan->status ? 'btn-success' : 'btn-warning' }}">
